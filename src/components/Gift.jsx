          ...
          >
            {showAccount ? (
              ...
              <>
                ...
                <svg className="w-4 h-4 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7}>
                  <rect x="3" y="5" width="18" height="14" rx="2.5" />
                  <path strokeLinecap="round" d="M3 10h18M7 15h3" />
                  <path strokeLinecap="round" strokeWidth={2.2} d="M15.5 15h.01" />
                </svg>
